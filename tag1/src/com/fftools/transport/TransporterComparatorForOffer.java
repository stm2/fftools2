...
/**
 * Sortiert Transporter nach Entfernung zu einer Beladungsregion
 * 
 * @author Fiete
 *
 */
public class TransporterComparatorForOffer implements Comparator<Transporter>{
	...
	public TransporterComparatorForOffer(int weight){
		this.weight = weight;
	}
