...
public class MailMessage {
    ...
    private Vector<String> headersKeys;
    private Vector<String> headersValues;
    ...
    private static final int OK_AUTH = 235;
  ...
  public MailMessage(String host, int port) throws IOException {
    this.port = port;
    this.host = host;
    replyto = new Vector<String>();
    to = new Vector<String>();
    cc = new Vector<String>();
    headersKeys = new Vector<String>();
    headersValues = new Vector<String>();
    connect();
    sendHelo();
  }
  ...
  public void setDate(){
	  ...
	  setHeader("Date", f.format(new Date()));
  }
  ...
  void sendDot() throws IOException {
    ...
    public void sendAUTH_PLAIN(String password)throws IOException {
    	int[] ok = {OK_AUTH};
    	send("AUTH PLAIN " + password, ok);
    }
