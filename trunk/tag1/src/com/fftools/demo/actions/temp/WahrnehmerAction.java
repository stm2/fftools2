 ...
 * @version
 */
public class WahrnehmerAction extends MenuAction {
	 ...
	 */
	public WahrnehmerAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Wahrnehmer");
	...
	private void makeIt(Unit u){
		...
		// name setzen
		tempUnit.addOrderAt(0, "BENENNEN EINHEIT Wahrnehmer ;dnt");
		// script Setzen
