 ...
 * @version
 */
public class HandelAction extends MenuAction {
	 ...
	 */
	public HandelAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Händler");
	...
	private void makeIt(Unit u){
		...
		// name setzen
		tempUnit.addOrderAt(0, "BENENNEN EINHEIT Händler ;dnt");
		// script Setzen
		tempUnit.addOrderAt(0, "// script Handeln minTalent=3");
