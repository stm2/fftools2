 ...
 * @version
 */
public class SoldatenRearAction extends MenuAction {
	 ...
	 */
	public SoldatenRearAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Soldaten Hinten");
	...
	private void makeIt(Unit u){
		...
		tempUnit.addOrderAt(0, "// script Lernfix Lernplan=ArmeeBogenschießen");
