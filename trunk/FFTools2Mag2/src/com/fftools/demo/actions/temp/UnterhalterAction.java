 ...
 * @version
 */
public class UnterhalterAction extends MenuAction {
	 ...
	 */
	public UnterhalterAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Unterhalter");
	...
	private void makeIt(Unit u){
		...
		// name setzen
		tempUnit.addOrder("BENENNEN EINHEIT Zirkus ;dnt");
		// script Setzen
		tempUnit.addOrder("// Tip: mindestAuslastung=[XX]  (In prozent)");
		tempUnit.addOrder("// script Unterhalten minTalent=3 mode=auto");
