 ...
 * @version
 */
public class TarnDepotAction extends MenuAction {
	 ...
	 */
	public TarnDepotAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Depot-Tarner");
	...
	private void makeIt(Unit u){
		...
		// script Setzen
		tempUnit.addOrderAt(0, "// script Depot");
		tempUnit.addOrderAt(0, "// Tip: DepotSilberPrio=[Prio]");
